...
insert  into `t_user`(`id`,`nickname`,`title`,`bepraised`,`initiationtimes`,`appid`,`gender`,`age`,`birthday`,`state`,`audio_imgid`,`plot_imgid`,`tags`,`avatar_imgid`,`create_time`,`update_time`) values (1,'系统','系统用户',0,0,NULL,1,1,NULL,1,NULL,NULL,NULL,NULL,'2023-04-01 09:14:09','2023-04-08 09:14:16');
